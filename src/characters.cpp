...
CVince::CVince(float x, float y, b2World* world, WeaponType weaponType)
    ...
    _character(Vince) {
    _animation = new Animation(_sprite, _texture, 3, sf::Vector2u(8,0), 32, 50, size_);
}
...
CNate::CNate(float x, float y, b2World* world, WeaponType weaponType)
    ...
    _character(Nate) {
    _animation = new Animation(_sprite, _texture, 4, sf::Vector2u(8,0), 32, 50, size_);
}
...
CMatt::CMatt(float x, float y, b2World* world, WeaponType weaponType)
    ...
    _character(Matt) {
    _animation = new Animation(_sprite, _texture, 1, sf::Vector2u(8,0), 32, 50, size_);
}
...
CJoy::CJoy(float x, float y, b2World* world, WeaponType weaponType)
    ...
    _character(Joy) {
    _animation = new Animation(_sprite, _texture, 2, sf::Vector2u(8,0), 32, 50, size_);
}
